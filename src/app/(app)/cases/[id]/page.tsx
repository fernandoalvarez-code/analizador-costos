...
const SectionTitle = ({ title }: { title: string }) => (
    <div className="bg-slate-100 px-3 py-1.5 text-[9px] font-bold text-slate-500 uppercase border-y border-slate-300 text-left tracking-wider flex items-center">{title}</div>
);
...
const FinancialRow = ({ label, valA, valB, save, pct }: FinancialRowProps) => (
    <div className="grid grid-cols-12 border-b border-green-100 px-3 bg-white text-[10px] min-h-[28px]">
      ...
      <div id="report-container" className="mx-auto w-fit bg-gray-100">
        ...
        <div className="pdf-page">
            ...
            <div className="mb-5">
                <div className="grid grid-cols-2 gap-6">
                    <div className="border border-slate-200 rounded-lg p-3 shadow-sm text-center bg-white">
                        ...
                        <p className={cn("text-3xl font-black mb-1 leading-none", r.toolCostIncreasePercent < 0 ? "text-green-600" : "text-slate-700")}>
                    ...
                    <div className="border border-slate-200 rounded-lg p-3 shadow-sm text-center bg-white">
                        ...
                        <p className={cn("text-3xl font-black mb-1 leading-none", r.totalCostReductionPercent > 0 ? "text-[#1A73E8]" : "text-slate-700")}>
            ...
            <div className="mb-5 border border-slate-300 rounded-t-lg rounded-b-lg overflow-hidden text-[10px] shadow-sm break-inside-avoid">
                ...
                <div className="grid grid-cols-10 border-b border-slate-200 px-3 bg-white items-center text-[10px] min-h-[26px]">
                ...
                <div className="grid grid-cols-10 bg-[#E8EAED] px-3 font-black border-t border-slate-300 text-[10px] tracking-wide min-h-[28px] items-center">
            ...
            <div className="border border-green-200 rounded-t-lg rounded-b-lg overflow-hidden text-[10px] shadow-sm break-inside-avoid">
                <div className="grid grid-cols-12 bg-[#E6F4EA] py-1.5 px-3 font-bold text-[#137333] border-b border-green-200 text-[10px] text-center tracking-wide items-center">
                ...
                <div className="grid grid-cols-12 bg-[#CEEAD6] px-3 font-black border-t border-green-300 text-center text-[10px] tracking-wide min-h-[30px] items-center">
