...
// --- SUB-COMPONENTES (Compactos y Legibles) ---

interface RowProps { label: string; valA: any; valB: any; bold?: boolean; isRed?: boolean; }

// AJUSTE CLAVE: text-[9px] y min-h-[20px]. Suficiente para leer, pequeño para entrar en la hoja.
    ...
    <div className="bg-gray-100 text-slate-900 font-sans printable-area min-h-screen">
      ...
      <div id="report-container" className="mx-auto w-fit bg-gray-100">
        ...
        <div className="pdf-page">
            ...
            <div className="mb-4 border-b-2 border-slate-800 pb-2">
                ...
                <div className="flex justify-between items-end mt-2">
                    {/* SOLUCIÓN AL CORTE DE NOMBRE: pb-1 y leading-normal */}
            ...
            {/* === DATOS DEL CLIENTE: ARREGLADO EL CORTE === */}
        ...
        <div className="pdf-page">
            ...
            {/* Comparativa Principal - Reducido margen mb-2 */}
            <div className="mb-2">
            ...
            {/* Tabla Técnica - AHORRA ESPACIO VERTICAL */}
            ...
            {/* Tabla Financiera - AHORRA ESPACIO VERTICAL */}
