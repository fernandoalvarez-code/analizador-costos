  ...
  return (
    <div className="bg-white text-slate-900 font-sans printable-area">
      ...
      <div id="report-container" className="bg-white w-full max-w-[210mm] mx-auto">
        ...
        {/* Padding reducido a p-8 para ganar espacio vertical */}
        <div className="p-8 flex flex-col relative bg-white h-auto html2pdf__page-break">
            ...
            {/* 2. Sección de Fotos (Altura reducida para asegurar espacio) */}
            <div className="flex-1 flex flex-col justify-center mb-4 min-h-[250px]">
            ...
            {/* 3. CONCLUSIÓN EJECUTIVA (EN PÁGINA 1) */}
            <div className="border-t border-slate-200 pt-4 mb-2">
                ...
                <div className="bg-slate-50 p-4 rounded-lg border border-slate-200 text-[10px] text-slate-800 leading-relaxed text-justify shadow-sm">
                    ...
                    <p className="text-slate-500 italic border-t border-slate-200 pt-2 mt-2 text-[9px]">
            ...
            {/* Footer Hoja 1 */}
            <div className="text-center pt-2 mt-auto"><p className="text-[9px] text-slate-400 uppercase tracking-widest">Generado con Analizador de Costos - Página 1/2</p></div>
        </div>
        ...
        <div className="p-8 pt-6 bg-white h-auto flex flex-col">
