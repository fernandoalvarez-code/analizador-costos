        ...
        <div className="min-h-screen w-full max-w-[210mm] mx-auto p-10 flex flex-col page-break-after-always relative border-b border-slate-100 print:border-none bg-white">
            ...
            <div className="flex justify-between items-center mb-10 h-20">
                <div className="w-1/3 flex justify-start">
                    {settings?.companyLogoUrl ? (/* eslint-disable-next-line @next/next/no-img-element */<img src={settings.companyLogoUrl} alt="Logo" className="h-16 object-contain" />) : <div className="h-12 w-32"></div>}
                </div>
                <div className="w-1/3 flex justify-end">
                    {settings?.secoLogoUrl ? (/* eslint-disable-next-line @next/next/no-img-element */<img src={settings.secoLogoUrl} alt="Seco" className="h-14 object-contain" />) : <div className="h-12 w-32"></div>}
                </div>
            </div>
            ...
            {validImages.length > 0 ? (
                <div className="flex-grow flex flex-col justify-center mb-4">
                    <div className="text-center mb-6 px-4">
                        <h3 className="text-sm font-bold text-blue-900 italic font-serif leading-relaxed">&ldquo;Se pueden conseguir Resultados o Excusas, no las dos cosas.&rdquo;</h3>
        ...
        <div className="min-h-screen w-full max-w-[210mm] mx-auto p-10 pt-12 page-break-before-always bg-white">
            ...
            <div className="flex justify-between items-center mb-6 border-b border-slate-200 pb-2">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <span className="text-lg font-bold text-slate-700 uppercase border-l pl-4 border-slate-300 block leading-none">Análisis Detallado</span>
                        <span className="text-[10px] text-slate-400 pl-4 mt-1 block uppercase tracking-wide">Basado en {data.piezasAlMes?.toLocaleString()} pzs/mes @ {formatCurrency(data.machineHourlyRate)}/hr</span>
                    </div>
                </div>
            ...
            <div className="mb-6 border border-blue-200 rounded-lg overflow-hidden shadow-sm break-inside-avoid">
                ...
                <div className="p-3 grid grid-cols-3 gap-4 bg-blue-50/30">
                    <div className="bg-white p-2 rounded border border-blue-100 shadow-sm text-center">
                        ...
                        <p className="text-lg font-bold text-blue-600">{r.machineHoursFreedAnnual?.toFixed(2)} hs</p>
                    </div>
                    <div className="bg-white p-2 rounded border border-blue-100 shadow-sm text-center">
                        <p className="text-[9px] font-bold text-slate-500 uppercase mb-1">Valor Prod. Adicional</p>
                        <p className="text-lg font-bold text-green-600">{formatCurrency(r.machineHoursFreedValueAnnual)}</p>
                    </div>
                    <div className="bg-white p-2 rounded border border-blue-100 shadow-sm text-center">
                        <p className="text-[9px] font-bold text-slate-500 uppercase mb-1">Piezas Adicionales</p>
                        <p className="text-lg font-bold text-slate-700">{r.piezasAdicionalesAnual?.toFixed(0)}</p>
                    </div>
                </div>
            </div>

            {/* 4. TABLA TÉCNICA (AGREGADA FILA DE COSTO PARADA) */}
            <div className="mb-6 border border-slate-300 rounded overflow-hidden text-sm shadow-sm">
                <div className="grid grid-cols-10 bg-slate-100 font-bold border-b border-slate-300 py-1 px-3 text-[10px]">
                    <div className="col-span-4">PARÁMETRO</div><div className="col-span-3 text-center text-red-600">ACTUAL (A)</div><div className="col-span-3 text-center text-blue-600">PROPUESTA (B)</div>
                </div>
                ...
                <div className="grid grid-cols-10 bg-slate-200 py-1 px-3 font-black border-t border-slate-300 text-[10px]">
            ...
            {/* 5. TABLA FINANCIERA (COMPLETA CON TURNOS Y COSTO PIEZA) */}
            <div className="border border-green-200 rounded overflow-hidden text-sm shadow-sm break-inside-avoid">
                <div className="grid grid-cols-12 bg-green-50 py-1 px-3 font-bold text-green-900 border-b border-green-200 text-[10px] text-center">
                    <div className="col-span-3 text-left">MÉTRICA</div><div className="col-span-2">ACTUAL</div><div className="col-span-2">PROPUESTA</div><div className="col-span-3">AHORRO</div><div className="col-span-2">%</div>
                </div>
                ...
                <div className="grid grid-cols-12 border-b border-green-100 py-1 px-3 bg-white items-center text-center text-[10px]">
                    <div className="col-span-3 font-medium text-slate-700 text-left">Tiempo Máquina (Mes)</div>
                ...
                <div className="grid grid-cols-12 border-b border-green-100 py-1 px-3 bg-white items-center text-center text-[10px]">
                    <div className="col-span-3 font-medium text-slate-700 text-left">Turnos 8hs (Mes)</div>
                ...
                <div className="grid grid-cols-12 bg-green-100 py-1 px-3 font-black border-t border-green-300 text-center text-[10px]">
